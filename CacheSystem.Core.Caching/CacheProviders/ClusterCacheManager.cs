...
namespace FG.TradingSystem.Core.Caching
{
    /// <summary>
    /// Represents a memory cache manager 
    /// </summary>
    public partial class ClusterCacheManager : CacheKeyService, ICacheManager
    {
        #region Fields
        ...
        public ClusterCacheManager(IHybridCachingProvider hybridCachingProvider, CacheConfig cacheConfig) : base(cacheConfig)
        {
